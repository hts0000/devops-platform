...
protoc.exe --proto_path %ROOT_PATH%/proto/ --plugin=protoc-gen-ts_proto=%FRONTEND_GEN_PATH%/node_modules/.bin/protoc-gen-ts_proto.cmd --ts_proto_opt=esModuleInterop=true,forceLong=string,outputEncodeMethods=false,outputPartialMethods=false,outputClientImpl=false,outputServices=false --ts_proto_out=%FRONTEND_GEN_PATH%/src/lib/%SERVICE%/api/gen/v1 --proto_path proto/%SERVICE% %SERVICE%.proto
